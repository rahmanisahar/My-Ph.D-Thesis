...
\label{sec: result}
    ...
    In this section we show the results of the neural networks trained using the \citetalias{Kinney96} template spectra (binned in 10\AA).
        ...
        \subsubsection{Classifying the Galaxy Sample}
         \label{sec: 1Dv}
            ...
            \begin{figure}
                ...
                \hfill
                \begin{subfigure}[b]{\textwidth}
                     \includegraphics[width=\textwidth]{../image_paper2/1d/SED_total1by3_fluxdensity.png}
                \end{subfigure}
           ...
           As in Figs.~\ref{fig: 1by2V} and ~\ref{fig: 1by3V}, the upper panel of Fig.~\ref{fig: 1by22V} shows the number of galaxies (out of the 142) belonging to each neuron in the $1\times22$ SOM.
            ...
            \begin{figure}
                ...
                \begin{subfigure}[b]{\textwidth}
                \centering
                     \includegraphics[width=\textwidth]{../image_paper2/1d/SED_total1by22_fluxdensity.png}
                \end{subfigure}
...
%        
    ...
    This approach can be used to trace and recognize the outliers, which could include galaxy types that are not presented in the \citetalias{Kinney96} templates (e.g. dwarf galaxies, luminous infrared galaxies, active galactic nucleus).
...
TThe properties of the galaxies in the \citetalias{Hossein12} sample using the new classification were found to be more tightly correlated in mean values of age, specific star formation rate, stellar mass, and far-UV extinction than in previous studies. 
