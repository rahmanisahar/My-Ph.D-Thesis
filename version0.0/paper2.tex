\chapter[Classifying High-Redshift Galaxies Using Self-Organizing Maps]{Clustering galaxy spectra at $0.5<z<1$: an unsupervised approach}
\label{ch: paper2}
...
Following the \citetalias{Hossein12} work, we chose these two sets of data not only to show the application of SOMs in SED clustering, but also to easily compare supervised and unsupervised methods.
 ...
 \subsection{Kinney Spectral Model}
     \begin{figure}
        ...
        \caption[\citet{Kinney96} spectra template for 12 types of galaxies]{\citet{Kinney96} spectra template for 12 types of galaxies from \citet{Hossein12} paper (Fig. 1 in \citet{Hossein12}). The type of each template is shown in each frame. Plots B, E, S0, Sa, Sb and SC show spectra that belong to the early types galaxies. Starburst galaxies spectra are indicated with SB 1 to 6. Higher numbers represent more intrinsic colour extinction.}
        \label{fig: k96}
    \end{figure}
    ...
    \label{sec: 1D_somz}
        ...
        \subsubsection{Classifying the Galaxy Sample}
         \label{sec: 1Dv}
            ...
            The lower left panel shows the median SED of the 80 galaxies that were classified as early type. 
            ...
            The median SED in the lower right panel of Fig.~\ref{fig: 1by2V} shows strong emission lines and bright ultraviolet continuum, indications of a high star formation rate.
            \begin{figure}
                \begin{subfigure}[b]{\textwidth}
                    \centering
           ...
           As in Figs.~\ref{fig: 1by2V} and ~\ref{fig: 1by3V}, the upper panel of Fig.~\ref{fig: 1by22V} shows the number of galaxies (out of the 142) belonging to each neuron in the $1\times22$ SOM.
            ...
            \begin{figure}
                ...
                \end{subfigure}
                \caption[Classification of fitted galaxy SEDs from \citet{Hossein12} using the $1\times22$~networks]{Same as Fig.~\ref{fig: 1by2V}, but in this figure, we used a network with size of $1\times22$ (Fig.~\ref{fig: 1by22T}) to classify the sample galaxies. In the median SED of each neuron, we can clearly see the changes from early type galaxies to the starburst ones. The 4000\AA~ break weakens from left to right and the emission line strengths increase.}
                \label{fig: 1by22V}
            \end{figure}

            The lower panels present the median SED of the galaxies in each neuron.
            Since galaxies had more space to separate, some of the neurons are left empty.
            Thus, instead of having 22 median SED plots in the lower part of Fig.~\ref{fig: 1by22V}, there are only 12.
            ...
            Otherwise, we can conclude that the SEDs of galaxies in the cluster are (dis)similar to two of the \citetalias{Kinney96} templates.
            ...
            19 of the galaxies are jn the fifth neurons and similar to the Sa type, while the 6 galaxies in the fourth neurons have SEDs similar to both S0 and Sa galaxies.
            There are 8 Sb type galaxy and 19 galaxies with SEDs similar to both Sa and Sb type galaxies.
            ...
            Therefore, 24 galaxies in the eighth neurons have similar SEDs to Sb type galaxies, and the SEDs of the 5 galaxies in the ninth neuron are similar to the SB6 galaxies.
...
%        
       ...
       Separating galaxies based on SED types also leads to a separation in properties that derived (via {\em CIGALE}) from the SEDs, as expected since the SED types are also based on {\em CIGALE} fitting. 
