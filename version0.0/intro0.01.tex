...
It can be written as ${\int T_{\mathrm CO} dV}$ where $T_{\mathrm CO}$(K) is the peak brightness temperature in the CO line and $V$ is the line-width in km~s$^{-1}$. %PB: please check this: I think \int should be omitted, dV should be \Delta V, and $V$ should also be $\Delta V$
