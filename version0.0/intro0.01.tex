...
It can be written as ${\int T_{\mathrm CO} dV}$ where $T_{\mathrm CO}$(K) is the peak brightness temperature in the CO line and $V$ is the line-width in km~s$^{-1}$. %PB: please check this: I think \int should be omitted, dV should be \Delta V, and $V$ in text should also be $\Delta V$
...
\begin{figure}
\centering
\includegraphics[width=15.5cm]{../image_intro/imf.png}
\small
...
The most common use of combined luminosities to trace the SFR is the combination of total infrared measurements with both far- and near-ultraviolet observations, with the latter being more commonly used. 
