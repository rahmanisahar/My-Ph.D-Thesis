...
Due to a coupling between the total angular momentum of the electron and the angular momentum (spin) of the nucleus, the ground state of hydrogen atom splits into two states that are separated in energy by an amount of 9.4E-25~J.
