...
By integrating the star formation history over a specific time scale, SFR can be derived. %PB: please check: integrate SFH to get SFR, or SFR to get SFH?
...
\end{equation}
where $\Sigma_0$ is the central surface brightness, and $R_d$ the disk scale length, where the ratio of the intensity of disk to bulge is $e$ ($\sim$2.71).  %PB: Not quite the right definition of scale length? Please check.
...
The higher resolution data %PB sentence incomplete.
...
%PB: quite a bit of repetition in the following sentences.
