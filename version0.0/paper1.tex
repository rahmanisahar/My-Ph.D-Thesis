...
A second method to calculate the SFR involved using a combination of \halpha\ and 24~$\mu$m emission. \citet{Massey06, Massey07} mapped M31 in broad and narrow bands, including \halphadot, as part of the Nearby Galaxies Survey using the KPNO 4-m telescope. A detailed description of how our \halpha\ map was made can be found in Appendix~\ref{app:halpha}.
